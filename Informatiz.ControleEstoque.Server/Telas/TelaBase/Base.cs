    ...
    public partial class Base : Form
    {
        ...
        private void RecuperarLinhaSelecionada(object sender)
        {
            if (sender != null && !DesabilitarSelecaoLinha)
            {
                ...
                if (!string.IsNullOrEmpty(Coluna) && !string.IsNullOrEmpty(objGrid.CurrentRow.Cells[Coluna].Value as string) && !objGrid.MultiSelect)
                {
    ...
    Properties.Resources.exit, new EventHandler(btnSair_Click), Keys.F11, false, false, false);
        ...
        public virtual void AcionarTeclaAtalho(Control controle)
        {
            ...
            if (_Atalhos != null && _Atalhos.Count > 0)
            {
                ...
                else if ((controle is Form) || (controle is MaskedTextBox) || (controle is ComboBox) || (controle is TextBox) || 
        ...
        public virtual void AlterarAlturaMenu(Int32 Height)
        {
            tlpTopo.RowStyles[0].Height = Height;
        }
        #endregion
