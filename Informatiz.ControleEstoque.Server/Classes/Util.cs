...
namespace Informatiz.ControleEstoque.Server.Classes
{
    public class Util
    {
        ...
        public static void SalvarArquivo(string Conteudo, string NomeArquivo, string Diretorio)
        {
            ...
            File.WriteAllLines(string.Format("{0}\\{1}.txt", Diretorio, NomeArquivo), new[] { Conteudo });
        }
