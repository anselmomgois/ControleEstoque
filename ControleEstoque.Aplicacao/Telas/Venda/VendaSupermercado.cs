...
{
    public partial class VendaSupermercado : TelaBase.BaseVenda
    {
        public VendaSupermercado(Comum.Clases.Caixa Caixa)
        {
            InitializeComponent();
            _Caixa = Caixa;
            _tipoTela = TelaVenda.VendaSupermercado;
        ...
        private Controles.ucGridVenda _ucGridVenda = null;
        #endregion
        ...
        protected override void MontarMenu(Boolean GerarGrupo)
        {
            ...
            this.AdicionarItemMenu(string.Empty, string.Empty, string.Empty, string.Empty, "Fechar Cupom (F5)", btnFecharCupom, Properties.Resources.badge, new EventHandler(btnFecharCupom_Click), Keys.F5, false, false, false);
            this.AdicionarItemMenu(string.Empty, string.Empty, string.Empty, string.Empty, "Pagamento Parc. Produto (F6)", btnPagamentoParcProduto, Properties.Resources.diagram_v2_17, new EventHandler(btnPagamentoParcialProduto_Click), Keys.F6, false, false, false);
            this.AdicionarItemMenu(string.Empty, string.Empty, string.Empty, string.Empty, "Pagamento Parc. Valor (F7)", btnPagamentoParcValor, Properties.Resources.cash_stack_add, new EventHandler(btnPagamentoParcial_Click), Keys.F7, false, false, false);
            this.AdicionarItemMenu(string.Empty, string.Empty, string.Empty, string.Empty, "Sangria (F8)", btnSangria, Properties.Resources.dollars, new EventHandler(btnSangria_Click), Keys.F8, false, false, false);
            this.AdicionarItemMenu(string.Empty, string.Empty, string.Empty, string.Empty, "Suprimento (F9)", btnSuprimento, Properties.Resources.coins_add, new EventHandler(btnSuprimento_Click), Keys.F9, false, false, false);
            this.AdicionarItemMenu(string.Empty, string.Empty, string.Empty, string.Empty, "Fechamento Caixa (F10)", btnFechamentoCaixa, Properties.Resources.cash_stack_add, new EventHandler(btnFechamento_Click), Keys.F10, false, false, false);
            this.AdicionarItemMenu(string.Empty, string.Empty, string.Empty, string.Empty, "Interromper Atendimento (F11)", btnPausarCaixa, Properties.Resources.player_pause, new EventHandler(btnPause_Click), Keys.F11, false, false, false);


            base.MontarMenu(GerarGrupo, !_Caixa.EstaAberto);
        }
        ...
        protected override void AtualizarControleFiltro()
        {
            base.AtualizarControleFiltro();
        ...
        protected override void RespostaAgente(object objSaida, SDK.Operacoes.operacao operacao, Comum.ParametrosTela.Generica Parametros)
        {
            ...
            if (operacao == SDK.Operacoes.operacao.CarregarGuardarVendaSupermercado)
            {
                _ucPesquisa.SetarFocus();
            }
            else if (operacao == SDK.Operacoes.operacao.RecuperarPagamentosCaixa)
            {
        ...
        protected override void ConfigurarVisibilidadeBotoes()
        {
            ...
            if (_Venda == null)
            {
                //if (!this.ItemMenuVisivel(string.Empty, string.Empty, btnCancelarItem))
                //{
                //    return;
                //}
