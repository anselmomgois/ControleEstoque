...
{
    public partial class InformarMesaAtendente : TelaBase.BaseCE
    {
        public InformarMesaAtendente(string IdentificadorVenda, Comum.Clases.Pessoa FuncionarioSelecionado, List<Comum.Clases.Mesa> MesasSelecionadas, Boolean RegistrarBase)
        {
            InitializeComponent();
