...
{
    public partial class RegistrarAcrescimosTouch : TelaBase.BaseCE
    {
        ...
        private Controles.ucTexboxTeclado _ucTextBoxSeqObservacao = null;
        ...
        public RegistrarAcrescimosTouch(List<Comum.Clases.ProdutoDisponivelVenda> pProdutos,
        ...
        private void CarregarTela()
        {
            ...
            LimparSelecao();
            CarregarControleBuscaProduto();
            CarregarControleSequenciaObservacao();
        }

        #region Controle Buscar Produto

        private void CarregarControleBuscaProduto()
        {
            _ucTextBoxBuscaProduto = new Controles.ucTexboxTeclado(pnlTxtBuscaProduto.Location.X + 10, pnlTxtBuscaProduto.Location.Y + 165, new FontFamily("Arial"), true, 25, this, true, 50, 50);
        ...
        #region Controle Sequencia Observacao

        private void CarregarControleSequenciaObservacao()
        {
            _ucTextBoxSeqObservacao = new Controles.ucTexboxTeclado(pnlSeqObservacao.Location.X + 555, pnlSeqObservacao.Location.Y + 165, new FontFamily("Arial"), true, 25, this, true, 50, 50);

            _ucTextBoxSeqObservacao.Dock = DockStyle.Fill;

            _ucTextBoxSeqObservacao.GetValorDigitado += _ucTextBoxSeqObservacao_GetValorDigitado;
            _ucTextBoxSeqObservacao.LimparValor += _ucTextBoxSeqObservacao_LimparValor;
            _ucTextBoxSeqObservacao.Focus();

            pnlSeqObservacao.Controls.Add(_ucTextBoxSeqObservacao);
        }

        private void _ucTextBoxSeqObservacao_GetValorDigitado(string Item)
        {
            if (string.IsNullOrEmpty(Item))
            {
            ...
            else
            {
                ...
                if (indiceRow >= 0)
                {
                    ...
                    _ucTextBoxSeqObservacao.SetarValor(null);
                    _ucTextBoxSeqObservacao.SetarFocus();
        ...
        private void _ucTextBoxSeqObservacao_LimparValor(object sender, EventArgs e)
        {
            try
            {
                _ucTextBoxSeqObservacao.SetarValor(null);
        ...
        private void btnLimparAcrescimo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _ucTextBoxBuscaProduto.SetarValor(null);
                _ucTextBoxBuscaProduto.SetarFocus();
